...
import { SRC_DIR, DIST_DIR, POSTS_DIR, STATIC_DIR, STYLES_DIR } from './constants';
import { buildPost } from './build/posts';
import { buildPage, pageConfigs } from './build/pages';
...
const updateHandler = (filepath, eventDescriptor) => {
  ...
  if (postMatch.test(filepath)) {
    ...
    // make one last check for paths matching a page
